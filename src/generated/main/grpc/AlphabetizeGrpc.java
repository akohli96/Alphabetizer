...
public final class AlphabetizeGrpc {
  ...
  public static final io.grpc.MethodDescriptor<AlphabetizeRequest,
      AlphabetizeResponse> METHOD_ALPHABETIZE = getAlphabetizeMethodHelper();

  private static volatile io.grpc.MethodDescriptor<AlphabetizeRequest,
      AlphabetizeResponse> getAlphabetizeMethod;

  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<AlphabetizeRequest,
      AlphabetizeResponse> getAlphabetizeMethod() {
    return getAlphabetizeMethodHelper();
  }

  private static io.grpc.MethodDescriptor<AlphabetizeRequest,
      AlphabetizeResponse> getAlphabetizeMethodHelper() {
    io.grpc.MethodDescriptor<AlphabetizeRequest, AlphabetizeResponse> getAlphabetizeMethod;
      ...
      synchronized (AlphabetizeGrpc.class) {
        if ((getAlphabetizeMethod = AlphabetizeGrpc.getAlphabetizeMethod) == null) {
          AlphabetizeGrpc.getAlphabetizeMethod = getAlphabetizeMethod = 
              io.grpc.MethodDescriptor.<AlphabetizeRequest, AlphabetizeResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "Alphabetize", "alphabetize"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  AlphabetizeRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  AlphabetizeResponse.getDefaultInstance()))
  ...
  /**
   * Creates a new async stub that supports all call types for the grpc
   */
  ...
  /**
   * Creates a new blocking-style stub that supports unary and streaming output calls on the grpc
   */
  ...
  /**
   * Creates a new ListenableFuture-style stub that supports unary calls on the grpc
   */
  ...
  public static abstract class AlphabetizeImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void alphabetize(AlphabetizeRequest request,
        io.grpc.stub.StreamObserver<AlphabetizeResponse> responseObserver) {
  ...
  public static final class AlphabetizeBlockingStub extends io.grpc.stub.AbstractStub<AlphabetizeBlockingStub> {
    ...
    /**
     */
    public AlphabetizeResponse alphabetize(AlphabetizeRequest request) {
  ...
  public static final class AlphabetizeFutureStub extends io.grpc.stub.AbstractStub<AlphabetizeFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<AlphabetizeResponse> alphabetize(
        AlphabetizeRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ALPHABETIZE:
          serviceImpl.alphabetize((AlphabetizeRequest) request,
              (io.grpc.stub.StreamObserver<AlphabetizeResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class AlphabetizeBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return AlphabetizeProto.getDescriptor();
    }
